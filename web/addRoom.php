...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $bookingResponse = $conn->query("INSERT INTO room_tb(room_type, room_name, room_description, room_pictures, creator_id, room_cost) VALUES('$room_type', '$room_name', '$room_description', '$allRoomPictures', '$userId', '$room_cost') ");

    if ($bookingResponse) {
        $success = $room_name . " successfully added";
        echo "<script> 
        setTimeout(() => {
...
<head>
    ...
    <title>Add Room || Experience a better world</title>
...
<div class="w-4/5 mx-auto md:w-1/3 md:mt-5 mt-8">
    ...
    <h3 class="text-gray-800 my-3 text-xl md:text-2xl">New Room Form</h3>
